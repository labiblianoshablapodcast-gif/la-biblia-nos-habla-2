...
export default function ElPastorPage() {
  return <>
    <section className={styles.hero}>
      <Image className={styles.heroImage} src="/images/pastor-hero-integrated-v2.webp" alt="Pastor Gilberto Maldonado" fill sizes="100vw" priority />
