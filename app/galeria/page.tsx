...
const albums=[
 ...
 {title:"Nuestros Pastores",subtitle:"Matrimonio, familia, llamado y servicio ministerial",image:"/images/pastor-y-yudelka-hero-v2.jpg",href:"/el-pastor"}
];
  ...
  <section className={galleryStyles.hero}>
   <div className={galleryStyles.heroInner}>
    ...
    <div className={galleryStyles.mosaic} aria-label="Momentos del ministerio">
     ...
     <figure className={galleryStyles.mosaicBottom}><img src="/images/pastor-y-yudelka-hero-v2.jpg" alt="Pastores Gilberto y Yudelka Maldonado"/></figure>
