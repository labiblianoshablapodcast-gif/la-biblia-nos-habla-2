...
export default function Misiones(){
 return <>
  <section className="missionsHero">
    <Image className="missionsWorldMap" src="/images/misiones/mapa-misionero-mundial-v2.jpg" alt="Mapa mundial misionero con énfasis en Guatemala, Puerto Rico y Estados Unidos" fill priority sizes="100vw"/>
