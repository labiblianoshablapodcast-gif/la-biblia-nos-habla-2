 ...
 return <main className={styles.home}>
  ...
  <section className={shortStyles.section} aria-labelledby="shorts-heading">
   ...
   {featuredShort
    ...
    :<div className={shortStyles.featured}>
      <div className={shortStyles.videoWrap}><ShortVideoPlayer url="/media/60-segundos-sabiduria-para-la-prueba.mp4" title="Sabiduría para la prueba" poster="/media/60-segundos-sabiduria-para-la-prueba.jpg"/></div>
      <div className={shortStyles.copy}>
       <small>VIDEO DESTACADO</small>
       <h3>Sabiduría para la prueba</h3>
       <p className={shortStyles.scripture}>Santiago 1:5–6</p>
