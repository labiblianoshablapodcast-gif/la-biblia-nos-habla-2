  ...
  {!loading&&!error&&videos.length>0&&<div className="layout">
   <article className="playerCard">
    <div className="stage">
      ...
      <div className={`cinemaFrame ${scene?"hasScene":""}`} style={scene?{backgroundImage:`url(${scene})`}:undefined} aria-hidden="true">
